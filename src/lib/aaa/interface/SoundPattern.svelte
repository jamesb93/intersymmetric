    ...
    const perc_sound_knob = Object.assign(
        {
            ...
            func: () =>
                set(ref(db, `/aaa/${$room}/perc_sound_preset`), $perc_sound_preset)
        },
        knob
    );
    ...
    const perc_transpose_knob = Object.assign(
        {
            ...
            func: () =>
                set(
                    ref(db, `/aaa/${$room}/perc_transpose_preset`),
                    $perc_transpose_preset
                )
        },
        knob
    ...
    const perc_shape_knob = Object.assign(
        {
            ...
            func: () =>
                set(ref(db, `/aaa/${$room}/perc_shape_preset`), $perc_shape_preset)
        },
        knob
    );
...
<div class="sound_pattern area">
    ...
    <div class="controls">
        <div class="panel">
            ...
            <Knob
                {...perc_sound_knob}
                bind:internal={$perc_sound_preset}
                bind:value={_perc_sound_preset} />
            <Knob
                {...perc_transpose_knob}
                bind:internal={$perc_transpose_preset}
                bind:value={_perc_transpose_preset} />
            <Knob
                {...perc_shape_knob}
                bind:internal={$perc_shape_preset}
                bind:value={_perc_shape_preset} />
        </div>
        ...
        <div class="panel">
            ...
            <Knob
                {...fm1_freq_knob}
                bind:internal={$fm1_freq_preset}
                bind:value={_fm1_freq_preset} />
            <Knob
                {...fm1_mod_knob}
                bind:internal={$fm1_mod_preset}
                bind:value={_fm1_mod_preset} />
            <Knob
                {...fm1_shape_knob}
                bind:internal={$fm1_shape_preset}
                bind:value={_fm1_shape_preset} />
        </div>
        ...
        <div class="panel">
            ...
            <Knob
                {...fm2_freq_knob}
                bind:internal={$fm2_freq_preset}
                bind:value={_fm2_freq_preset} />
            <Knob
                {...fm2_mod_knob}
                bind:internal={$fm2_mod_preset}
                bind:value={_fm2_mod_preset} />
            <Knob
                {...fm2_shape_knob}
                bind:internal={$fm2_shape_preset}
                bind:value={_fm2_shape_preset} />
        </div>
    </div>
</div>
