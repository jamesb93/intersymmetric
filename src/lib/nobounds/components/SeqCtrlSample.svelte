<script>
    ...
    import { 
        ...
        playbackRate } from '$lib/nobounds/app'
    ...
    import { 
        ...
        numSamples,
        numLoadedSamples,
        totalNumSamples  } from '$lib/nobounds/samplerConfig.js';
    ...
    <div id='centre-section'>
        <div id='clock' class='control-column-container'>
            ...
            <div id='clock-top'>
                ...
                <Knob resetValue={0} scale={0.2} title="Multiplier" min={0} max={22} step={1} bind:value={$clockMultiplierLookup} bind:altValue={clockMultiplier} func={sendMultiplier} />
            </div>
            <div id='clock-bottom'>
