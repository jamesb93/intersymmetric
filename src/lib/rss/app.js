...
const firebaseConfig = env.PUBLIC_MODE === 'dev' || 
...
// All the sliders...
export const s0 = writable(0.0)
export const s1 = writable(0.0)
export const s2 = writable(0.0)
export const s3 = writable(0.0)
export const s4 = writable(0.0)
export const s5 = writable(0.0)
export const s6 = writable(0.0)
export const s7 = writable(0.0)
export const s8 = writable(0.0)
export const s9 = writable(0.0)
export const s10 = writable(0.0)
export const s11 = writable(0.0)
export const s12 = writable(0.0)
export const s13 = writable(0.0)
export const s14 = writable(0.0)
export const s15 = writable(0.0)
