...
<div class="container">
    ...
    <div class="row grid">
        ...
        <Knob {...divKnob} bind:value={$div0} func={ () => set(ref(db, `/nnnb/${$room}/div0`), $div0) } />
        <Stepper
            {...stepper}
            bind:value={$range0}
            bind:div={$div0}
        ...
        />
        <Knob {...soundKnob} bind:value={$buf0} func={ () => set(ref(db, `/nnnb/${$room}/buf0`), $buf0) } />
        <Knob {...pitchKnob} bind:value={$pitch0} func={ () => set(ref(db, `/nnnb/${$room}/pitch0`), $pitch0) } />
        <Knob {...lenKnob} bind:value={$len0} func={ () => set(ref(db, `/nnnb/${$room}/len0`), $len0) } />
    </div>
    <div class="row grid">
        <Blip bind:this={blips[1]} />
        <Knob {...divKnob} bind:value={$div1} func={ () => set(ref(db, `/nnnb/${$room}/div1`), $div1) } />
        <Stepper
            {...stepper}
            bind:value={$range1}
            bind:div={$div1}
        ...
        />
        <Knob {...soundKnob} bind:value={$buf1} func={ () => set(ref(db, `/nnnb/${$room}/buf1`), $buf1) } />
        <Knob {...pitchKnob} bind:value={$pitch1} func={ () => set(ref(db, `/nnnb/${$room}/pitch1`), $pitch1) } />
        <Knob {...lenKnob} bind:value={$len1} func={ () => set(ref(db, `/nnnb/${$room}/len1`), $len1) } />
    </div>
    <div class="row grid">
        <Blip bind:this={blips[2]} />
        <Knob {...divKnob} bind:value={$div2} func={ () => set(ref(db, `/nnnb/${$room}/div2`), $div2) } />
        <Stepper
            {...stepper}
            bind:value={$range2}
            bind:div={$div2}
        ...
        />
        <Knob {...soundKnob} bind:value={$buf2} func={ () => set(ref(db, `/nnnb/${$room}/buf2`), $buf2) } />
        <Knob {...pitchKnob} bind:value={$pitch2} func={ () => set(ref(db, `/nnnb/${$room}/pitch2`), $pitch2) } />
        <Knob {...lenKnob} bind:value={$len2} func={ () => set(ref(db, `/nnnb/${$room}/len2`), $len2) } />
    </div>
    <div class="row grid">
        <Blip bind:this={blips[3]} />
        <Knob {...divKnob} bind:value={$div3} func={ () => set(ref(db, `/nnnb/${$room}/div3`), $div3) } />
        <Stepper
            {...stepper}
            bind:value={$range3}
            bind:div={$div3}
        ...
        />
        <Knob {...soundKnob} bind:value={$buf3} func={ () => set(ref(db, `/nnnb/${$room}/buf3`), $buf3) } />
        <Knob {...pitchKnob} bind:value={$pitch3} func={ () => set(ref(db, `/nnnb/${$room}/pitch3`), $pitch3) } />
        <Knob {...lenKnob} bind:value={$len3} func={ () => set(ref(db, `/nnnb/${$room}/len3`), $len3) } />
    </div>
</div>
